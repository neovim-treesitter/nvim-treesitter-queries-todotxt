# nvim-treesitter-queries-todotxt

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-todotxt/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-todotxt/actions/workflows/validate.yml)

Neovim tree-sitter queries for **todotxt**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-todotxt",
...
- [ ] Changes are scoped to `todotxt` — do not include files for other languages
